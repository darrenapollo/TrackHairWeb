...
related_pages:
  - title: Hair loss guide
    description: Understand pattern hair loss in men and women and how to plan a routine.
    url: /hair-loss/
  - title: Treatment library
    description: Review the main hair loss treatment categories and what to track for each.
    url: /treatments/
  - title: How to take progress photos
    description: Capture repeatable photos that make change easier to judge over months.
    url: /hair-loss-progress-photos/
campaign_token: web-about
---
...
Track Hair is built privacy-first. Progress photos are personal, and the product is designed around keeping your record yours. This website keeps tracking to a minimum and does not run advertising trackers. You can read the full [privacy policy](/privacy/) for details on how the app handles your data.

## Contact

Questions, corrections, or feedback are welcome at [hello@track.hair](mailto:hello@track.hair). If you spot something in a guide that is out of date or unclear, telling us helps everyone who reads it next.

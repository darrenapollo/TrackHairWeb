...
faq:
  - question: What causes pattern hair loss?
    answer: It is generally linked to genetics, follicle miniaturization, aging, and androgen sensitivity. The visible pattern can differ between men and women.
  - question: Can hair loss be tracked meaningfully at home?
    answer: Yes, but meaningful tracking depends on consistent photos, stable routines, treatment history, and realistic review windows rather than daily mirror checks.
  - question: What should I read after this page?
    answer: Start with the pattern information below, then move to specific guides such as minoxidil, finasteride, spironolactone, microneedling, PRP, or transplant recovery depending on your situation.
citations:
...
related_pages:
  - title: Female pattern hair loss guide
    description: Review female hair loss planning, treatment tracking, and photo workflows.
    url: /female-pattern-hair-loss/
  - title: Norwood scale guide
    description: See how one visible pattern of male hair loss is commonly described.
    url: /norwood-scale/
...
The [Norwood scale](/norwood-scale/) is the most common framework used to describe visible stage and pattern in men. Female pattern hair loss is usually described differently because it often affects density over the top and crown rather than creating the same receding hairline pattern. Both descriptions are useful for orientation, but neither should be treated as a complete diagnosis.

## Main treatment categories

### Medical treatment

[Minoxidil](/minoxidil/) is commonly discussed for both men and women with pattern hair loss. [Finasteride](/finasteride/) is one of the most established prescription options for men and may be discussed off-label for some women, but it is not appropriate for anyone who is pregnant or may become pregnant. [Spironolactone](/spironolactone/) is another prescription option often discussed for women with female pattern hair loss when a clinician thinks androgen sensitivity is relevant.
